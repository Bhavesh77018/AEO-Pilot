    ...
    <section className="mx-auto max-w-5xl px-6 py-20">
      <Reveal className="mb-12 text-center">
        ...
        <p className="mt-4 text-white/50">
          SEO optimizes for Google. AEO optimizes for the AI answer your buyer gets.
        </p>
      </Reveal>
      ...
      <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02]">
        ...
        {comparisons.map((row, i) => (
          <div key={i} className="grid grid-cols-3 gap-0 border-b border-white/5 last:border-b-0">
      ...
      <div className="mt-10 rounded-xl border border-brand-500/30 bg-brand-500/10 p-6">
        <p className="text-sm leading-relaxed text-white/80">
          <strong className="text-brand-300">The shift:</strong> As buyers move
          from searching to asking, the brands{" "}
          <span className="font-semibold text-white">cited in AI answers</span>{" "}
          win consideration. AEO Pilot tells you exactly what to fix on your site
          so ChatGPT, Gemini, Claude, and Perplexity mention you — then measures
